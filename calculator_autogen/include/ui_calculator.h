...
"}"));
        ...
        scrollArea->setStyleSheet(QString::fromUtf8("QScrollArea QWidget {\n"
"	background-color: rgb(49, 74, 111);\n"
"}\n"
"\n"
""));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 142, 144));
        gridLayout_2 = new QGridLayout(scrollAreaWidgetContents);
        gridLayout_2->setObjectName("gridLayout_2");
        EQdispaly = new QLabel(scrollAreaWidgetContents);
        EQdispaly->setObjectName("EQdispaly");
        EQdispaly->setStyleSheet(QString::fromUtf8("QLabel{\n"
"	\n"
"	background-color: rgb(49, 74, 111);\n"
"	border:none;\n"
"	color: rgb(255, 255, 255);\n"
"}"));
        ...
        gridLayout_2->addWidget(EQdispaly, 0, 0, 1, 1);

        scrollArea->setWidget(scrollAreaWidgetContents);

        gridLayout->addWidget(scrollArea, 0, 3, 1, 2);
